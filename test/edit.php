	...
	if(isset ($_POST['submit'])){
		...
		$imagepath=$_FILES['image']['tmp_name'];
		 ...
		 if($imagepath){
		 	...
		 	$update=mysqli_query($conn,"UPDATE publication_info SET title='$title',comment='comment',image='$picture',website='website',email='$email',datep='$datep' WHERE id='$id'");
		 	if($update){
		 		echo"good";
		 	...
		 	$update=mysqli_query($conn,"UPDATE publication_info SET title='$title',comment='$comment',website='$website',email='$email',datep='$datep' WHERE id='$id'");
		 	if($update){
		 		echo"good";
		 		echo "<script language='Javascript'>";
		 		echo "document.location.replace('./home.php')";
